...
document.addEventListener('DOMContentLoaded', () => {
    ...
    socket.on('fighterMoved', ({ fighterId, position }) => { /* ... (mesmo código) */ });
    ...
    socket.on('gmPromptToAdmit', ({ playerId, character }) => { /* ... (mesmo código) */ });
    socket.on('promptForAdventureType', () => { /* ... (mesmo código) */ });
    socket.on('attackResolved', ({ attackerKey, targetKey, hit }) => { /* ... (mesmo código) */ });
    socket.on('fleeResolved', ({ actorKey }) => { /* ... (mesmo código) */ });
